...
(function ($) { /* start closure */
  ...
  $.fn.registerWatcher = function (watchWhichDimensions, /* optional */ innerElementSelector) {
    ...
    var watchHeight = watchWhichDimensions.indexOf('height') !== -1
		;
  ...
  ResizeEvents.heartbeat = function () {
    ...
    var resizeWatchFunction = function () {
      var $this = $(this);
      var elementData = $this.data('resizeEvents');
      var $inner = $this.find(elementData.innerElementSelector).eq(0)
					;
