...
$(() => {
  ...
  if ($(figureElement).length) {
    console.warn(`".qg-cut-in" and ".qg-cut-in-alt" is going to be deprecated in SWE library. Please replace ".qg-cut-in" or ".qg-cut-in-alt" with ".qg-fig" before 22nd Dec 2022. Please refer to https://qld-gov-au.github.io/web-template-release/components/images.html for more details.`);
  }
});
