(function ($) {
  ...
  const qgSocialMedia = {
    ...
    init: function () {
      ...
      const facebookSdkScript = 'connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v12.0';
      ...
      if (this.config.$facebookEl.length > 0 && $('script[src*="' + facebookSdkScript + '"]').length <= 0) {
        this.config.$facebookEl.each(function () {
          const curr = $(this);
          const fbUrl = curr.attr('data-href');
          const fbhtml = '<div class="fb-page" data-href="' + fbUrl + '" data-tabs="timeline" data-small-header="true" data-width="10000"  data-adapt-container-width="true" data-show-facepile="false"></div>';
          curr.append(fbhtml);
        });
