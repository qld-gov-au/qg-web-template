...
(function ($) {
  ...
  var DEFAULT_STATUS_HTML = `<div class="alert alert-warning mt-4" id="qg-forms__validation-errors" role="alert"><div class="inner"><h2><i class="fa fa-exclamation-triangle"></i>${validationErrorMessage}</h2><ol></ol></div></div>`;
