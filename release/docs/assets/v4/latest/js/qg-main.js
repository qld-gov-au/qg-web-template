...
/***/ (function(module, exports) {
	...
	if (!browserSupportsDateInput() && $('input[type=\'date\']').length > 0) {
	  $.getScript('https://static.qgov.net.au/assets/v4/latest/lib/ext/nodep-date-input-polyfill/nodep-date-input-polyfill.dist.js', function () {
	    console.log('date polyfill loaded');
	  });
	}
	if ($('input[class=\'qg-date-input\']').length > 0) {
	  $.getScript('https://static.qgov.net.au/assets/v4/latest/lib/ext/jquery-ui-bundle/jquery-ui.min.js', function () {
	    $('head').append($("<link rel='stylesheet' href='https://static.qgov.net.au/assets/v4/latest/lib/ext/jquery-ui-bundle/jquery-ui.min.css' type='text/css' media='screen' />"));
...
/***/ (function(module, exports) {
	...
	(function ($, qg) {
	  ...
	  var licenceOptions = {
	    ...
	    imgSrc: 'https://static.qgov.net.au/assets/v4/latest/images/licences/',
	    types: {
	      'by': {
	        'name': 'Attribution',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function ($, swe) {
	  ...
	  */
	  ...
	  var googleRecaptchaApiKey = isProd() ?
	  _qgGoogleKeys2.default.defGoogleRecaptcha.prod :
	  _qgGoogleKeys2.default.defGoogleRecaptcha.uat; //This is a v2 key
	  var footerFeedbackGoogleRecaptchaApiKey = isProd() ?
	  _qgGoogleKeys2.default.defFeedbackGoogleRecaptcha.prod :
	  _qgGoogleKeys2.default.defFeedbackGoogleRecaptcha.uat; //This is a v3 key
	  ...
	  var onloadRecaptchaAjax = function onloadRecaptchaAjax() {
...
/***/ (function(module, exports) {
	...
	'use strict';if ($("script[src*='jquery.fancybox']").length === 0) {
	  if ($('.qg-image-gallery').length > 0 || $('.qg-lightbox').length > 0 || $('.image-gallery').length > 0 || $('.cut-in').length > 0) {
	    $('head').append($("<link rel='stylesheet' href='https://static.qgov.net.au/assets/v4/latest/lib/ext/fancybox/jquery.fancybox.min.css' type='text/css' media='screen' />"));
	    $.getScript('https://static.qgov.net.au/assets/v4/latest/lib/ext/fancybox/jquery.fancybox.min.js', function () {
	      // image gallery
...
/***/ (function(module, exports) {
	...
	'use strict';$('.no-js').removeClass('no-js');
